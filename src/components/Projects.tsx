  ...
  return (
    <section id="projects" className="py-12 w-full">
      <div className="w-full px-2 sm:px-4 lg:px-6 mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-0 w-full justify-center px-8 ml-5">
              {projects.map((project, index) => (
                <div
                  key={index}
                  className="bg-red-50 bg-opacity-100 backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden card-hover fade-in w-full max-w-sm border-[1px] border-[#cbb4e8] flex-shrink-0"
                >
